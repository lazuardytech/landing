    ...
    <div className="flex flex-col w-full">
      <LayoutLine>
        <div className="grid grid-cols-1 md:grid-cols-3 w-full">
          ...
          <div className="w-full flex justify-center border-t md:border-t-0 border-neutral-400 border-opacity-90">
            <div className="flex w-full h-full aspect-[9/16] opacity-60">
              <LEXAVideo />
            </div>
          </div>
        </div>
