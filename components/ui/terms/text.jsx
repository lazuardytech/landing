    ...
    <div className="container px-10 lg:px-16 mt-16 mb-16 lg:mt-32 lg:mb-32">
      ...
      <div className="text-white font-light text-md lg:text-md max-w-2xl mx-auto text-justify">
        ...
        <div className="mt-4">
          ...
          may not copy, distribute, modify, or create derivative works from our
          content without our express permission. Unauthorized use of our
        ...
        <div className="mt-4">
          ...
          due as stated on the website or as agreed upon with Lazuardy. We
        ...
        <div className="mt-4">
          You agree to indemnify and hold harmless Lazuardy, its affiliates, and
          employees from any claims, liabilities, damages, or expenses
