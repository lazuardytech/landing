export const CompanyData = {
	...
	// company name
	tradeName: "Lazuardy Tech",

	// company legal name
	legalName: "PT Inovasi Kolektif Digital",

	// company number
	number: "2910240067449",
	...
	// company description
	description: "We help businesses grow bigger through modern technology.",

	// company copyright
	copyright: {
		label: `Copyright Lazuardy Tech ${new Date().getFullYear()}. All rights reserved.`,
		html: (
			<span>
